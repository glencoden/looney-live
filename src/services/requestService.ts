...
class RequestService {
    ...
    getSetlists() {
        return this._get(`https://api.looneytunez.de/repertoire/setlist`) // TODO: revert to this.baseUrl
    }
    ...
    getSong(id: number) {
        return this._get(`https://api.looneytunez.de/repertoire/songs/${id}`) // TODO: revert to this.baseUrl
    }
}
